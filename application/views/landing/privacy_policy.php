  ...
  <div class="container pb-5">
    <div class="row justify-content-center py-3">
      <div class="col-lg">
        ...
        <p>Lapor Pak membuat aplikasi Lapor Pak sebagai aplikasi Gratis. LAYANAN ini disediakan oleh Lapor Pak tanpa biaya dan dimaksudkan untuk digunakan apa adanya.</p> 
        ...
        <p>Istilah yang digunakan dalam Kebijakan Privasi ini memiliki arti yang sama seperti dalam Syarat dan Ketentuan kami, yang dapat diakses di Lapor Pak kecuali ditentukan lain dalam Kebijakan Privasi ini.</p>

        <h4>Pengumpulan dan Penggunaan Informasi</h4>

        <p>Untuk pengalaman yang lebih baik, saat menggunakan Layanan kami, kami mungkin meminta Anda untuk memberikan kami informasi pengenal pribadi tertentu termasuk, namun tidak terbatas pada laporpak@gmail.com. Informasi yang kami minta akan disimpan oleh kami dan digunakan seperti yang dijelaskan dalam kebijakan privasi ini.</p>
        ...
        <h4>Hubungi kami</h4>
        <p>Jika Anda memiliki pertanyaan atau saran tentang Kebijakan Privasi kami, jangan ragu untuk menghubungi kami di laporpak@gmail.com.</p>
      </div>  
    </div>
  </div>
</main>